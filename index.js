...
Kon = await getBuffer(`https://hardianto.xyz/api/welcome3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://media.discordapp.net/attachments/815702335325339658/977608385711210566/images_1_28.jpeg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)

Tol = await getBuffer(`https://hardianto.xyz/api/goodbye3?profile=${encodeURIComponent(ppuser)}&name=${encodeURIComponent(nama)}&bg=https://media.discordapp.net/attachments/815702335325339658/977608385711210566/images_1_28.jpeg&namegb=${encodeURIComponent(metadata.subject)}&member=${encodeURIComponent(memb)}`)
                if (anu.action == 'add') {
...
⭐✑ Welcome To Our Comfortable And Mystical Home But Take Note Rule Of Law Supercedes!!`} )
